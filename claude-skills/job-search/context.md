...
### wiki.advik.one — Personal Knowledge Wiki

Advik's personal wiki documents technical experiments and self-hosting projects: a Firecracker microVM deep dive (it's the Linux Playground project), a P2P file share experiment, an automated self-hosted finance manager, and Nix exploration. The blog section includes a Python for-loop internals writeup and a self-hosting 101 guide. CLI tool docs cover iperf3, smartctl, kernel compilation, and clipboard sharing over SSH.
